...
export default function ScrollTop ({
    ...
    return (
        <button className={`scroll-top py-3 px-4 w-max xl:text-2xl rounded-full ml-auto block hover:scale-[1.05] transition-all duration-[300ms] ${location === 'home' ? 'bg-night' : 'bg-beige'} ${location === 'home' ? 'text-beige' : 'text-night'}`}>Back to Top 
