            ...
            <footer className="px-8 py-8 sm:px-14 lg:px-20">
                ...
                <div className="flex justify-between lg:gap-40 mt-6 xs:max-w-[25rem] xl:max-w-[35rem]">
                    ...
                    <div className="flex flex-col mb-3">
                        ...
                        <Link ref={(l)=>{link.current[1]=l}} href={'https://www.linkedin.com/in/kanav-midha-24781b259/'} className="text-lg xl:text-[1.5rem] py-[0.15rem] relative after:h-[2px] after:w-0 after:block after:absolute hover:after:w-full after:origin-bottom-left after:transition-all after:duration-[200ms] w-min">LinkedIn</Link>
                        <Link ref={(l)=>{link.current[2]=l}} href={'https://github.com/kanavmidha'} className="text-lg xl:text-[1.5rem] py-[0.15rem] relative after:h-[2px] after:w-0 after:block after:absolute hover:after:w-full after:origin-bottom-left after:transition-all after:duration-[200ms] w-min">Github</Link>
                        <Link ref={(l)=>{link.current[3]=l}} href={'/'} className="text-lg xl:text-[1.5rem] py-[0.15rem] relative after:h-[2px] after:w-0 after:block after:absolute hover:after:w-full after:origin-bottom-left after:transition-all after:duration-[200ms] w-min">Resume</Link>
                    </div>
                </div>
